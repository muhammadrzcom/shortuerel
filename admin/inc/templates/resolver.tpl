        ...
        <div class="logged"><p>Welcome, <span><?php echo $config['username']; ?></span> | <a href="logout.php">Logout</a></p></div>
            ...
            <div id="main">
                <div class="fullwidth">
                        ...
                        <input type="button" class="submit filter" value="add New" onClick="window.location.href='edit.php?action=new&from=resolver'" style="margin:4px -20px 0 0;" />
        				...
        				<table class="data display">
                            ...
                            if ( $urls ){
                                ...
                                foreach($urls as $url ){
                                    ...
                                    $html .= '<td>'.$url['name'].'</td>';
                                    $html .= '<td>'.$url['date'].'</td>';
                                    $html .= '<td><a href="edit.php?action=edit&from=resolver&id='.$url['ID'].'">edit</a> | <a href="edit.php?action=delete&from=resolver&id='.$url['ID'].'" rel="askdelete">delete</a></td>';
                                    $html .= '</tr>'."\r\n";
                                }
                                echo $html;
                            } 
